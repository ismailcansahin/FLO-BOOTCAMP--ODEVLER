...
if($_POST){
    ...
    $sorgu = $baglan->prepare("select * from admin where email = ? && parola = ?");
    ...
    if($kayitsay > 0){
        ...
        window.location.href='yonetici_index.php'
        </script>";
    }
    else{
...
<!-- Yönetici giriş sayfası html kodları başlangıcı -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        <div class="forms">
            <div class="form login">
                <span class="title">Yönetici Giriş Yap</span>
                ...
                <div class="login-signup">
                    <span class="text">Standart kullanıcı iseniz </span>
                    <a href="login.php" class="text signup-text">buraya tıklayınız.</a>
                </div>
            </div>
        </div>
    </div>
